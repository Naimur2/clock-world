            ...
            function startClock(x) {
                ...
                if (el.timeCorrection) {
                    if (el.timeCorrection.operator === "+") {
                        theDate.setHours(
                            theDate.getHours() + el.timeCorrection.hours
                        );
                        theDate.setMinutes(
                ...
                if (el.alarmTime !== undefined) {
                    allExtM =
                        el.alarmTime.getHours() * 60 * 60 +
                        el.alarmTime.getMinutes() * 60 +
                        el.alarmTime.getSeconds();
                }
